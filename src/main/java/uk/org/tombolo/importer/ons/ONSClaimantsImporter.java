 ...
 *
 * {
 *  "importerClass": "uk.org.tombolo.importer.ons.ONSClaimantsImporter",
...
public class ONSClaimantsImporter extends AbstractONSImporter {
    ...
    private enum AttributeId {claimantsCount,JSAclaimantsCount,JSAclaimantsProportion,ESAclaimants};
