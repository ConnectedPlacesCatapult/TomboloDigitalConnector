...
public class TimeseriesMeanValueFieldTest extends AbstractTest {
    TimeseriesMeanValueField field;
    Subject subject;
    Attribute attribute;
    ...
    public void setUp() throws Exception {
        ...
        field = new TimeseriesMeanValueField("aLabel", new AttributeMatcher(TestFactory.DEFAULT_PROVIDER.getLabel(), "attr_label", null));
    }
