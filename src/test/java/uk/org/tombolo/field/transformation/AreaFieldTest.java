...
public class AreaFieldTest extends AbstractTest {
    ...
    public void testAreaField() throws Exception{
        ...
        Subject subjectSquare5 = TestFactory.makeSubject(TestFactory.DEFAULT_PROVIDER, subjectType.getLabel(),
                "square5",
                "square5",
        ...
        Subject subjectSquare7 = TestFactory.makeSubject(TestFactory.DEFAULT_PROVIDER, subjectType.getLabel(),
                "square7",
                "square7",
        ...
        Subject subjectPoint = TestFactory.makeSubject(TestFactory.DEFAULT_PROVIDER, subjectType.getLabel(),
                "point",
                "point",
        ...
        Subject subjectLine = TestFactory.makeSubject(TestFactory.DEFAULT_PROVIDER, subjectType.getLabel(),
                "line",
                "line",
