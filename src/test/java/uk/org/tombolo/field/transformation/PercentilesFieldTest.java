...
public class PercentilesFieldTest extends AbstractTest {
    ...
    public void valueForSubjectInverseQuintiles() throws Exception {
        assertEquals("5.0", quintilesInverseField.valueForSubject(leeds1, true));
        assertEquals("5.0", quintilesInverseField.valueForSubject(leeds2, true));
        assertEquals("4.0", quintilesInverseField.valueForSubject(leeds3, true));
        assertEquals("4.0", quintilesInverseField.valueForSubject(leeds4, true));
        assertEquals("3.0", quintilesInverseField.valueForSubject(leeds5, true));
        assertEquals("3.0", quintilesInverseField.valueForSubject(brighton1, true));
        assertEquals("2.0", quintilesInverseField.valueForSubject(brighton2, true));
        assertEquals("2.0", quintilesInverseField.valueForSubject(brighton3, true));
        assertEquals("1.0", quintilesInverseField.valueForSubject(brighton4, true));
        assertEquals("1.0", quintilesInverseField.valueForSubject(brighton5, true));
    }
