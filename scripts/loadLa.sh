...
psql -d tombolo -c "insert into subject(subject_type_label, label, name, shape) select 'localAuthority', ctyua12cd, ctyua12nm, ST_Transform(ST_SETSRID(geom, 27700),4326) from la"
