...
psql -d tombolo -c "insert into geography_object(geography_type_label, label, name, shape) select 'lsoa', lsoa11cd, lsoa11nm, ST_Transform(ST_SETSRID(geom, 27700),4326) from lsoa"
